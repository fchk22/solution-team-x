...
const translations: any = {
  en: {
    ...
    nudgeGuest: "Log in & complete profile to unlock paid AI for faster, smarter responses!",
    nudgeBasic: "Complete your profile to unlock paid AI for faster, smarter responses!",
  ...
  zh: {
    ...
    logout: "登出",
    profile: "個人檔案",
    nudgeGuest: "登入並填寫資料，解鎖付費版 AI 獲取更快更聰明的解答！",
    nudgeBasic: "填寫個人資料，解鎖付費版 AI 獲取更快更聰明的解答！",
  ...
  cn: {
    ...
    logout: "登出",
    profile: "個人檔案",
    nudgeGuest: "登錄並填寫資料，解鎖付費版 AI 獲取更快更聰明的解答！",
    nudgeBasic: "填寫個人資料，解鎖付費版 AI 獲取更快更聰明的解答！",
    placeholder: "詢問關於滙豐信用卡或申請資格...",
    thinking: "AI 引擎正在分析...",
    save: "保存並開啟 VIP AI",
